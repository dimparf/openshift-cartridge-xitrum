...
object $_scalate_$xitrum_scalate_string_mustache {
...
class $_scalate_$xitrum_scalate_string_mustache extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$xitrum_scalate_string_mustache.$_scalate_$render(context)
}
