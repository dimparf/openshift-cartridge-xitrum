...
object $_scalate_$xitrum_scalate_string_scaml {
...
class $_scalate_$xitrum_scalate_string_scaml extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$xitrum_scalate_string_scaml.$_scalate_$render(context)
}
